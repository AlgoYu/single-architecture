...
INSERT INTO authority VALUES(@ID+3,'修改${moduleName}','${className?upper_case}:MODIFY',@ID,NULL);
INSERT INTO authority VALUES(@ID+4,'查询${moduleName}','${className?upper_case}:GET',@ID,NULL);