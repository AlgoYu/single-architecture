...
import cn.machine.geek.controller.WebSocketController;
...
public class WebSocketServerConfig implements WebSocketConfigurer {
    ...
    */
    ...
    public RedisMessageListenerContainer redisMessageListenerContainer(RedisConnectionFactory redisConnectionFactory, MessageListenerAdapter messageListenerAdapter){
        ...
        redisMessageListenerContainer.addMessageListener(messageListenerAdapter, WebSocketController.WEB_SOCKET_CHANNEL_TOPIC);
